...
void fileRecord(char);                                          // Declare function fileRecord                     
...
void fileRecord(char beta) {
    fstream file("record.txt", ios::app);                                       // open file record.txt and set the edit mode to append
    file << "Player " << beta << " wins\n";                                     // add this quote
